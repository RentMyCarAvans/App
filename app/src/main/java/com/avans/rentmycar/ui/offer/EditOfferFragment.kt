...
import com.avans.rentmycar.databinding.MyoffersItemBinding
...
class EditOfferFragment : Fragment() {
    ...
    private var _binding: MyoffersItemBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = MyoffersItemBinding.inflate(inflater, container, false)
    ...
    fun bindUI(args: OfferCarFragmentArgs) {
        Log.d(TAG, "bindUI()")
        binding.textviewOfferTitle.setText(args.licenseplate)
        binding.textviewCarOfferStartdate.setText(args.startdate)
        binding.textviewCarOfferEnddate.setText(args.enddate)
        binding.textviewCarOfferLocation.text = (args.location)
    }
    ...
    private fun createOffer(id: Int) {
        ...
        // Cast inputfields
        /*
        val offerStartDate: TextInputEditText = binding.textviewCarOfferStartdate
